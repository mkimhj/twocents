...
Template.team.events({
	'mouseenter #maruchi-pic': function(event) {
		$('#founder-text').text("Maruchi is a recent UC Berkeley graduate.  During his time at Berkeley, he was a web design team director of one of Berkeley's premier design club, Innovative Design. He also conducted research at UCSF's Microdevices Lab where he engineered embedded solutions to improve the clinical environment for patients, nurses, and doctors. Maruchi originally thought of Two Cents while donating his pocket change to a homeless man in a Seoul metro station, and thought that small daily donations from everyone could help a lot of people. Since then, he has formed a team of his close friends who all believe that crowdfunded pocket change donations can make a difference.");
